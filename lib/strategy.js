...
Strategy.prototype.authenticate = function (req) {
    ...
    if (!(req.body?.shared_token || req.query?.shared_token)) throw new Error('OneID authentication requires a shared_token option');

    let self = this;

    this._config.shared_token = req.body?.shared_token ?? req.query?.shared_token;
